import s from "../assets/styles/Player.module.css"

const Player = () => {
    return (
        <div className={s.player + " player"}>
            ...
            <div className={s.nowPlaying}>
                <div className={s.songInfo}>
                    ...
                    <img
                        ...
                        alt=""/>
                    <a href="">Song Name - Song Desc Song Name - Song Desc</a>
                </div>
                <div className={s.likeSongButton}>
                    <i className={"far fa-heart"}/>
                    {/*<i className={"fa fa-heart"}/>*/}
                </div>
            </div>
            <div className={s.playerControl}>
                <div className={s.playerControlButtons}>
                ...
                <div className={s.playerControlTimer}>
                    <span>00:30</span>
                    <meter className={s.playerControlTimerMeter + " w-80"} value={50} min={0} max={100}/>
                    <span>01:00</span>
                </div>
            </div>
            <div className={s.anotherPlayerButtons}>
                <i className={"fas fa-list-ul"}/>
                <i className={"fas fa-desktop"}/>
                <i className={"fas fa-volume-mute"}/>
